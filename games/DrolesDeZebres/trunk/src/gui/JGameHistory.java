...
/**
	...
	/**
	 * Met en place un nouvel GameHistory et sélectionne le premier
	 * Mouvement.
	 * @param p_history
	 */
	...
	/**
	 * A appeler quand history a été modifié.
	 * Pour remettre la list_mvt à jour.
	 */
	...
	/**
	 * Sélectionne l'EtatJeu à la position p_position.
	 * historyPosition est contraint entre 0 et history.size().
	 * @param p_position
	 * @return false si history n'est pas initialisé.
	 */
	...
	/**
	 * Impose un nouveau Mouvement à la position donnée. Tout l'historique est 
	 * changé de manière descendante.
	 * @param p_position
	 * @param mvtStr String décrivant le Mouvement
	 */
