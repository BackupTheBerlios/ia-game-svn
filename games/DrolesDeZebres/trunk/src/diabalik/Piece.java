...
/**
 * Une Piece pour Diabalik : un type, une fa�on de s'afficher et appartient �
 * un Player. 
...
public class Piece {
	...
	/**
	 * Pr�pare une chaine de format joueur+type+val.
	 */
	...
	/**
	 * Le format long pour une piece, en ayant appel� setDisplayStr auparavant.
	...
	/**
	 * Juste un caract�re qui d�pend du type.
	 * @return String
	 */
	...
	/**
	 * Cr�e un String a partir d'un indice de type.
	 * @param p_type
	 * @return
	 */
	...
	/**
	 * Renvoie le type de la piece cod�e par ce token.
	 * @param token
