...
public class EtatJeu {
	...
	public ArrayList bestMoves; // meilleurs Mvt � faire
	public boolean valide;
	public String errMsg;
	
	/**
	 * Le premier Player est � sp�cifier.
	 * Attention, les Joueurs ne sont pas cr��s!
...
//            }
    ...
    public String toString()
    {
		...
		// pr�sente les valeurs des r�gions
		strbuf.append( "\n valRegions = ");
