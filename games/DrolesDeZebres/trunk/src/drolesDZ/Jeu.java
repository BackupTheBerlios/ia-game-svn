...
public class Jeu {
	...
	throws GameException
	{
	    if( mvt != null ) {
	        ...
	        if( !poserPieceRegles(mvt.zeJoueur.couleur, mvt.zeType, mvt.posL, mvt.posC)) {
	            throw new GameException( "Pose de Piece irr�guli�re : " + mvt.toString());
	        }
	        for( int ind=1; ind < mvt.nbEchange; ind++ ) {
	            if( !switchCrocoGazelleRegles( mvt.echL[ind-1], mvt.echC[ind-1], mvt.echL[ind], mvt.echC[ind] )) {
	                throw new GameException( "Echange de Piece irr�gulier : " + mvt.toString());
	            }
	        }
	        if( computeValidMoveIndiana() == false ) {
	            ...
	            if( !bougerIndianaRegles( mvt.nbIndiana) ) {
	                throw new GameException( "Mvt Impala irr�gulier : "+mvt.toString());
	            }
	        }
	        computeBonusScore();
	        nextJoueur();
	...
	/**
	 * Un Player essaie de poser une Piece, et les r�gles sont appliqu�es.
	...
	/**
	 * Essaie de poser Indiana en respectant les r�gles.
	 * @param position
	...
	public boolean validIndiana()
	{
		...
		// bien embett� car ni sur une ligne ni sur une colonne
		return false;
	}
	...
	/**
	 * Si un lion est � c�t�, zebre ou gazelle sont flipp�s.
	 * @param ligne du JPlateau
	 * @param col du JPlateau
	 */
	 ...
	 * @param ligne du JPlateau
	 * @param col du JPlateau
	 * @return true si un lion est � c�t�
	 */
	 ...
	 * derri�re une rivi�re.
	 * @param ligne du Plateau
	 * @param col du Plateau
	 * @return Tableau[4][2] avec des -1 ou des coordonn�es LxC de cases
	 */
	 ...
	 * En fonction de la pr�sence de lion, la gazelle peut se retrouver flipp�e.
	 * @param crocoL
	 * @param crocoC
	 * @param gazL
	 * @param gazC
	 * @return true si on a r�ussi
	 */
	...
	/**
	 * Si le joueur vient de terminer une r�gion, il a un bonus de 5.
	 * @param p_joueur qui vient de jouer.
	 * @return true si bonus accord�
	 */
