...
public class T_CarteTest extends TestCase {
    ...
    {
        super.setUp();
        mu1 = new Mutisme( Plateau.VERT );
        mu2 = new Mutisme( Plateau.ROUGE );
        boa1 = new BoostAttaque( Plateau.ROUGE );
        boa2 = new BoostAttaque( Plateau.ROUGE );
