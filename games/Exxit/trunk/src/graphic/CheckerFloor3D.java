...
public class CheckerFloor3D
{
    ...
    // create tiles, add origin marker, then the axes labels
    {
        ...
        floorBG.addChild( new ColouredTiles3D(blueCoords, blue) );
        floorBG.addChild( new ColouredTiles3D(greenCoords, green) );
        
        addOriginMarker();
        labelAxes();
    }  // end of CheckerFloor3D()
    ...
    {  // points created counter-clockwise, a bit above the floor
        ...
        floorBG.addChild( new ColouredTiles3D(oCoords, medRed) );
