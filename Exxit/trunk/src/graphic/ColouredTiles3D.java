...
// ColouredTiles3D.java
// Andrew Davison, April 2005, ad@fivedots.coe.psu.ac.th

// ColouredTiles3D creates a coloured quad array of tiles.
...
public class ColouredTiles3D extends Shape3D 
{
  ...
  public ColouredTiles3D(ArrayList<Point3f> coords, Color3f col) 
  {
  ...
  private void createAppearance()
  {
    ...
    pa.setCullFace(PolygonAttributes.CULL_NONE);   
      // so can see the ColouredTiles3D from both sides
